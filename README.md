...
## foxglove_bridge (jazzy) - 0.8.4-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy foxglove_bridge --override-release-repository-push-url git@github.com:revyos-ros/foxglove_bridge-release.git` on `Thu, 06 Mar 2025 15:05:55 -0000`
...
The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble foxglove_bridge --override-release-repository-push-url git@github.com:revyos-ros/foxglove_bridge-release.git` on `Mon, 17 Feb 2025 01:30:50 -0000`
...
The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/tmp/venv/bin/bloom-release -r jazzy foxglove_bridge --override-release-repository-push-url git@github.com:revyos-ros/foxglove_bridge-release.git` on `Wed, 18 Dec 2024 16:11:40 -0000`
...
The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble foxglove_bridge --override-release-repository-push-url git@github.com:revyos-ros/foxglove_bridge-release.git` on `Thu, 12 Dec 2024 08:40:43 -0000`
...
The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy foxglove_bridge --override-release-repository-push-url git@github.com:revyos-ros/foxglove_bridge-release.git` on `Thu, 26 Sep 2024 08:58:43 -0000`
...
The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble foxglove_bridge --override-release-repository-push-url git@github.com:revyos-ros/foxglove_bridge-release.git` on `Thu, 12 Sep 2024 04:01:44 -0000`
...
## foxglove_bridge (humble) - 0.7.7-2

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble foxglove_bridge` on `Tue, 28 May 2024 07:26:43 -0000`
